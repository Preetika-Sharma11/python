...
print(min([10,20,30]))
print(max([10,20,30]))
print(round(3.14526,2))
print("CSE,3rd Sem!".isalnum())
print("123abc".isalnum())
print("123".isalnum())# works as "OR" so either case true or false gives true
print("AB".isalnum()) # as long as the string contains aplhabets OR numbers 
print(type(10))
print(type('$'))
